...
const sundaKeyword = `lamun|jadi|munteu|misal|mun|salami|dina|mah`;
const sundaAnd = `sareng|jeung`;
const sundaNot = `can|teu`
const sundaNotEqual = `sanes`
const sundaOr = `atawa|atanapi`;
const sundaOperator = `samisareng|teh`;
const sundaTrue = `muhun|leres|heeh|enya|puguh|atos|tos|aktif|hurung`;
const sundaFalse = `salah|henteu|teu|lepat|acan|teuacan|pareum|parem|nonaktif`;

    function s() {
        var e = "[$A-Za-z_\\x7f-\\uffff][$\\w\\x7f-\\uffff]*",
            t = `${sundaNotEqual}|${sundaNot}|${sundaTrue}|${sundaFalse}|${sundaKeyword}|${sundaAnd}|${sundaOr}|${sundaOperator}|this|throw|then|try|typeof|super|switch|return|break|by|continue|catch|class|in|instanceof|is|isnt|if|else|extends|for|own|finally|function|while|when|new|no|not|delete|debugger|do|loop|of|off|or|on|unless|until|and|yes|yield|export|import|default`,
